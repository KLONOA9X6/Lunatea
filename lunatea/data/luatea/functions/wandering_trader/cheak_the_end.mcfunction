# 特色可出售物品
execute if predicate luatea:random/20 run data modify entity @s[type=wandering_trader,tag=!the_end_check] Offers.Recipes append value {priceMultiplier:0.08f,rewardExp:5b,maxUses:5,buy:{id:"minecraft:emerald",Count:2b},sell:{id:"minecraft:minecraft:chorus_flower",Count:1b,tag:{display:{Lore:['{"text":"随手丢雪球砸下来的","color":"white"}']}}}}
