...
execute in minecraft:overworld if entity @s[x=-32,y=67,z=0,distance=..5] run give @s minecraft:oak_log 6
execute in minecraft:overworld if entity @s[x=-32,y=67,z=0,distance=..5] run effect give @s minecraft:saturation 20 255
gamemode survival @s
