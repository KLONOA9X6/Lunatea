...
execute as @a in minecraft:overworld run playsound minecraft:block.end_portal.spawn neutral @s ~ ~ ~ 1 2
execute as @a in minecraft:overworld run playsound minecraft:block.end_portal.spawn neutral @s ~ ~ ~ 1 0
execute as @a in minecraft:overworld run playsound minecraft:entity.wither.spawn neutral @s ~ ~ ~ 1 0
