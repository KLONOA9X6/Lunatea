...
execute if entity @s[predicate=luatea:technical/ring/mainhand] run item replace entity @s weapon.mainhand with crossbow{CustomModelData:101,display:{Name:'{"text":"风之指环","italic": false,"color":"gold"}',Lore:['{"text":""}','{"text":"配有一颗闪亮绿色宝石的巨型金色指环，花费灵魂使用","italic": false}','{"text":"来源于末地上空的灵魂，似乎那灵魂背后就是原先的主","italic": false}','{"text":"人，据考证只有那主人才能发挥其完整的力量。","italic": false}']},HideFlags:5, Unbreakable:1,Enchantments:[{id:"quick_charge",lvl:4}],luatea:1}
execute if entity @s[predicate=luatea:technical/ring/offhand] run item replace entity @s weapon.offhand with crossbow{CustomModelData:101,display:{Name:'{"text":"风之指环","italic": false,"color":"gold"}',Lore:['{"text":""}','{"text":"配有一颗闪亮绿色宝石的巨型金色指环，花费灵魂使用","italic": false}','{"text":"来源于末地上空的灵魂，似乎那灵魂背后就是原先的主","italic": false}','{"text":"人，据考证只有那主人才能发挥其完整的力量。","italic": false}']},HideFlags:5, Unbreakable:1,Enchantments:[{id:"quick_charge",lvl:4}],luatea:1}
